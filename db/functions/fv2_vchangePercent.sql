create function fv2_vchangePercent(ccompany varchar(10), adate date) returns double DETERMINISTIC
begin
  declare bdate date;
  ...
  set cp = 100*changeee/(select volume from v2_TRADING_DAYS where cid=ccid and date=bdate);
